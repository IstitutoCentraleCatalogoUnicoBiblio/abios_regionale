 ...
 * Schema.
 * $Id: MaterialeCataloghiTypeDescriptor.java,v 1.4 2012/11/22 09:50:20 m.bartolozzi Exp $
 */
...
import it.inera.abi.logic.formatodiscambio.castor.MaterialeCataloghiType;

/**
 * Class MaterialeCataloghiTypeDescriptor.
 * 
 * @version $Revision: 1.4 $ $Date: 2012/11/22 09:50:20 $
 */
public class MaterialeCataloghiTypeDescriptor extends it.inera.abi.logic.formatodiscambio.castor.descriptors.MaterialeTypeDescriptor {
    ...
    public MaterialeCataloghiTypeDescriptor() {
        super();
        setExtendsWithoutFlatten(new it.inera.abi.logic.formatodiscambio.castor.descriptors.MaterialeTypeDescriptor());
        _xmlName = "materialeCataloghiType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                MaterialeCataloghiType target = (MaterialeCataloghiType) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return it.inera.abi.logic.formatodiscambio.castor.MaterialeCataloghiType.class;
    }
