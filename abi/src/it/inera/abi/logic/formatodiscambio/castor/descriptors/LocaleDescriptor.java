 ...
 * Schema.
 * $Id: LocaleDescriptor.java,v 1.1 2012/06/22 13:54:50 m.bartolozzi Exp $
 */
...
public class LocaleDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LocaleDescriptor() {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(it.inera.abi.logic.formatodiscambio.castor.types.SiNoType.class, "_prestitoLocaleAutomatizzato", "automatizzato", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException
            {
                ...
                return target.getPrestitoLocaleAutomatizzato();
            }
            @Override
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Locale target = (Locale) object;
                    target.setPrestitoLocaleAutomatizzato( (it.inera.abi.logic.formatodiscambio.castor.types.SiNoType) value);
        ...
        //-- validation code for: _prestitoLocaleAutomatizzato
        ...
        desc.setValidator(fieldValidator);
        //-- _durata
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_durata", "durata", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Locale target = (Locale) object;
                    target.setDurata( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setValidator(fieldValidator);
        //-- _utentiAmmessiList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_utentiAmmessiList", "utenti-ammessi", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
            ...
            {
                Locale target = (Locale) object;
                return target.getUtentiAmmessi();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Locale target = (Locale) object;
                    target.addUtentiAmmessi( (java.lang.String) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        //-- validation code for: _utentiAmmessiList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
    ...
    public java.lang.Class getJavaClass(
        ...
        return it.inera.abi.logic.formatodiscambio.castor.Locale.class;
    }
