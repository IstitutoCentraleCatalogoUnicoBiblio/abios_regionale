 ...
 * Schema.
 * $Id: Alternative.java,v 1.1 2012/07/31 15:00:07 m.bartolozzi Exp $
 */
...
public class Alternative implements java.io.Serializable {
     ...
     * it.inera.abi.logic.formatodiscambio.castor.Alternative
     */
    public static it.inera.abi.logic.formatodiscambio.castor.Alternative unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (it.inera.abi.logic.formatodiscambio.castor.Alternative) org.exolab.castor.xml.Unmarshaller.unmarshal(it.inera.abi.logic.formatodiscambio.castor.Alternative.class, reader);
    }
