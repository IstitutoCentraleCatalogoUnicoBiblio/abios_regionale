...
public class IstituzioneDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public IstituzioneDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Istituzione target = (Istituzione) object;
                return target.getDataIstituzione();
            }
            @Override
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Istituzione target = (Istituzione) object;
                    target.setDataIstituzione( (it.inera.abi.logic.formatodiscambio.castor.DataIstituzione) value);
        ...
        desc.setSchemaType("it.inera.abi.logic.formatodiscambio.castor.DataIstituzione");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _dataIstituzione
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Istituzione target = (Istituzione) object;
                return target.getDataFondazione();
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Istituzione target = (Istituzione) object;
                    target.setDataFondazione( (it.inera.abi.logic.formatodiscambio.castor.DataFondazione) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("it.inera.abi.logic.formatodiscambio.castor.DataFondazione");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);

        //-- validation code for: _dataFondazione
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return it.inera.abi.logic.formatodiscambio.castor.Istituzione.class;
    }
