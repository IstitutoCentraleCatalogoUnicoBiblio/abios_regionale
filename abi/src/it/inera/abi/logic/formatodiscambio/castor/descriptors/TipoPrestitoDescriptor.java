 ...
 * Schema.
 * $Id: TipoPrestitoDescriptor.java,v 1.7 2012/11/22 09:50:20 m.bartolozzi Exp $
 */
...
/**
 * Class TipoPrestitoDescriptor.
 * 
 * @version $Revision: 1.7 $ $Date: 2012/11/22 09:50:20 $
 */
public class TipoPrestitoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TipoPrestitoDescriptor() {
        super();
        _xmlName = "tipo-prestito";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TipoPrestito target = (TipoPrestito) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _ruolo
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(it.inera.abi.logic.formatodiscambio.castor.types.RuoloType.class, "_ruolo", "ruolo", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TipoPrestito target = (TipoPrestito) object;
                    target.setRuolo( (it.inera.abi.logic.formatodiscambio.castor.types.RuoloType) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(it.inera.abi.logic.formatodiscambio.castor.types.RuoloType.class, handler);
        desc.setImmutable(true);
        desc.setSchemaType("it.inera.abi.logic.formatodiscambio.castor.types.RuoloType");
        desc.setHandler(handler);
    ...
    public java.lang.Class getJavaClass(
        ...
        return it.inera.abi.logic.formatodiscambio.castor.TipoPrestito.class;
    }
