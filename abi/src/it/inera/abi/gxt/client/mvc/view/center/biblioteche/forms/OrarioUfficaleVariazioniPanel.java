...
import it.inera.abi.gxt.client.mvc.view.center.biblioteche.widget.VariazioneOrarioWindow;
...
public class OrarioUfficaleVariazioniPanel extends ContentPanelForTabItem {
	...
	private VariazioneOrarioWindow variazioneOrarioWindow = null;
	...
	public OrarioUfficaleVariazioniPanel() {
		...
		this.variazioneOrarioWindow = new VariazioneOrarioWindow();
		variazioneOrarioWindow.addListener(Events.Hide, new Listener<BaseEvent>() {
			@Override
			public void handleEvent(BaseEvent be) {
				loadLoaders();
				variazioneOrarioWindow.resetForm();
			}
		});
	...
	public void createVariazioniOrariForm() {
		...
		addVar.addSelectionListener(new SelectionListener<ButtonEvent>() {
			...
			public void componentSelected(ButtonEvent ce) {
				variazioneOrarioWindow.resetForm();
				variazioneOrarioWindow.setIdBiblio(id_biblio);
				variazioneOrarioWindow.show();
