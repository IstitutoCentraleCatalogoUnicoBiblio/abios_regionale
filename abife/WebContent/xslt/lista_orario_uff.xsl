...
<tr><td class="verdeCenter3">ORARIO UFFICIALE</td></tr>
...
<xsl:for-each select="arr[@name = 'orario_ufficiale']/str">
...
<xsl:choose>
	<xsl:when test="(string-length($lunedi) = 0) and (string-length($martedi) = 0) and (string-length($mercoledi) = 0) and (string-length($giovedi) = 0) and (string-length($venerdi) = 0) and (string-length($sabato) = 0) and (string-length($domenica) = 0)">
	<tr>
	<td class="verdeLeft3" width="25%" height="10%">Orario di accesso</td>
	<td class="grigioLeft1" width="75%"><font color="Red">Dato non definito</font></td>
	</tr>
	</xsl:when>
	<xsl:otherwise>
	<tr>
	  <td class="verdeLeft3" width="25%" height="10%">Orario di accesso</td>
	  <td class="verdinoCenter1" width="25%">mattina (8:00/14:00)</td>
	  <td class="verdinoCenter1" width="25%">pomeriggio (14:00/20:00)</td>
	  <td class="verdinoCenter1" width="25%">sera (20:00/24:00)</td>
...
<table width="100%" border="0">
<tbody><tr><td><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td></tr>
<tr>
	<td class="verdeLeft3" width="45%">Totale ore settimanali</td>
    <xsl:choose>
		<xsl:when test="number(int[@name = 'n_ore_settimanali']) = 0">
			<td class="grigioLeft1" width="55%"><font color="Red">Dato non definito</font></td>
		</xsl:when>
		<xsl:otherwise>
			 <td class="grigioLeft1" width="55%"><xsl:value-of select="int[@name = 'n_ore_settimanali']"/></td>
		</xsl:otherwise>
	</xsl:choose>
...
<tbody><tr><td><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td></tr>
<tr>
	<td class="verdeLeft3" width="45%">Totale ore settimanali pomeridiane</td>
	<xsl:choose>
		<xsl:when test="number(int[@name = 'n_ore_settimanali_pom']) = 0">
			<td class="grigioLeft1" width="55%"><font color="Red">Dato non definito</font></td>
		</xsl:when>
		<xsl:otherwise>
			 <td class="grigioLeft1" width="55%"><xsl:value-of select="int[@name = 'n_ore_settimanali_pom']"/></td>
		</xsl:otherwise>
	</xsl:choose>
...
<tbody><tr><td><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td></tr>
<tr>
	<td class="verdeLeft3" width="45%">Totale settimane di apertura</td>
    <xsl:choose>
		<xsl:when test="number(int[@name = 'n_settim_apertura']) = 0">
			<td class="grigioLeft1" width="55%"><font color="Red">Dato non definito</font></td>
		</xsl:when>
		<xsl:otherwise>
			 <td class="grigioLeft1" width="55%"><xsl:value-of select="int[@name = 'n_settim_apertura']"/></td>
		</xsl:otherwise>
	</xsl:choose>
