...
<title>Anagrafe Biblioteche Italiane - Sezioni speciali</TITLE>
...
function seleziona(SEZSPEC)
{
	window.opener.document.formOptions.sezioni_speciali.value = substHTMLBiachi(SEZSPEC);
...
<TR><TD CLASS="verdeCenter3" align="center" colspan="2">SEZIONI SPECIALI</TD></TR>

<solr:SolrDisplay xsl="helpSezioni" parameters="pagina_url:${pageContext.request.requestURL}|query_url:${pageContext.request.queryString}|torna:${requestScope.queryStringEncoded}" />
