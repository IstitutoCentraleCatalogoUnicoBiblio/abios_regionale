...
function seleziona(SPECIAL, DEWEY)
{
	window.opener.document.formOptions.descrizione_ufficiale.value = substHTMLBiachi(SPECIAL);
	//Se undefined e' false quindi ci troviamo sulla ricerca semplice che non ha il campo DEWEY
	if(window.opener.document.formOptions.codice_dewey)
		window.opener.document.formOptions.codice_dewey.value = substHTMLBiachi(DEWEY);
...
<TR><TD CLASS="verdeCenter3" align="center" colspan="2">SPECIALIZZAZIONE</TD></TR>
<TR>
	<TD class="verdinoLeft2" width="100"><b>Codice Dewey</b></TD>
	<TD class="verdinoLeft2"><b>Descrizione</b></TD>
</TR>

<solr:SolrDisplay xsl="helpDewey" parameters="pagina_url:${pageContext.request.requestURL}|query_url:${pageContext.request.queryString}|torna:${requestScope.queryStringEncoded}" />
